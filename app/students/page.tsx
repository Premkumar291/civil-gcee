    ...
    <main className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <section className="py-20 bg-white min-h-[50vh] flex flex-col items-center justify-center flex-grow">
        <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl md:text-5xl text-primary-dark font-bold mb-4">Students Section</h2>
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Information about Placements, Projects, Research, and Symposiums will be updated here soon.
            </p>
